...
public class ListFactoryTests {
  ...
  @ParameterizedTest
  @ValueSource(classes = { Set.class, LinkedHashSet.class })
  public void shouldThrowForNonListTypes(Class<? extends Collection<?>> collectionClass) {
  ...
  public void shouldThrowForConcreteListTypes(Class<? extends Collection<?>> collectionClass) {
    assertThrows(CollectionInstantiationException.class, () -> factory.instantiate(collectionClass, 3), () -> "ListFactory can't instantiate - " + collectionClass);
  }

  @ParameterizedTest
  @ValueSource(classes = { List.class, AbstractList.class })
  public void shouldSucceedForAbstractListTypes(Class<? extends Collection<?>> collectionClass) {
    ...
    assertEquals(ArrayList.class, result.getClass(), "Abstract list should be instantiated as ArrayList");
  }
}
